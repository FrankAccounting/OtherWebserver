...
<nav class="navigation">
    ...
    <p class="menu-item"><a href="createHero.html">packagexml.beans.Characters</a></p>
    <p class="menu-item"><a href="characterDelete.html">View All packagexml.beans.Characters</a></p>
    <p class="menu-item"><a href="skills.html">Skills</a></p>
    <p class="menu-item"><a href="characterDelete.html">Create Item(s)</a></p>
...
<div class="main">
    ...
    <p class="category"><a href="characterDelete.html">Delete A Hero</a></p>
</div>
</body>
</html>